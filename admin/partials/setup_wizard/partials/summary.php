 ...
 */
function mo_oauth_client_summary(){
  ...
  echo '<label>Client Secret :</label>  <div style="position: relative;">  
      <i class="fa fa-eye" onclick="showClientSecret(\'client_secret_summary\',\'show_button_summary\')" id="show_button_summary"></i> 
  ...
  jQuery(document.body).on("click", ".mo-editstep" ,function(e){
        mo_oauth_get_step(jQuery(e.target).attr("data-step"));
    });
</script>';
