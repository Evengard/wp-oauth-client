		...
		if ( ! isset($_GET['appId'] ) ) {
			...
			if ( $currentapp ) {
				...
				<table class="mo_settings_table">
					...
					<tr><td></td>
					<td><input class="mo_table_textbox" id="callbackurl"  type="text" name="mo_oauth_callback_url" value='<?php echo esc_attr( site_url() )."";?>'>
					&nbsp;&nbsp;
					...
					<tr id="mo_oauth_custom_app_name_div">
						...
						<td><input class="mo_table_textbox" onkeyup="updateFormAction()" type="text" id="mo_oauth_custom_app_name" name="mo_oauth_custom_app_name" value="<?php echo esc_attr( $tempappname ); ?>" pattern="^[a-zA-Z0-9]+( [a-zA-Z0-9\s]+)*$" required title="Please do not add any special characters." placeholder="Do not add any special characters" maxlength="14"></td>
					</tr>
