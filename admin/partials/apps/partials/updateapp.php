		...
		<table class="mo_settings_table">
            ...
            <?php if(isset($refapp->discovery) && $refapp->discovery !="" && get_option('mo_existing_app_flow') == true ) { ?>
                ...
                <tr>
                    ...
                    <td><input <?php if($valid_discovery == 'invalid') echo 'style="border-color:red;"'?> class="mo_table_textbox" type="text" name="mo_oauth_provider_domain"
                               value="<?php echo esc_attr($currentapp['domain']); ?>">&nbsp;&nbsp;&nbsp;<?php if($valid_discovery == 'valid'){echo $is_valid; } else echo $is_invalid; ?></td>
                </tr>
            <?php } elseif (isset($currentapp['tenant'])) { ?>
                    <tr>
                        ...
                        <td><input <?php if($valid_discovery == 'invalid') echo 'style="border-color:red;"'?> class="mo_table_textbox" type="text" name="mo_oauth_provider_tenant"
                                   value="<?php echo esc_attr($currentapp['tenant']); ?>">&nbsp;&nbsp;&nbsp;<?php if($valid_discovery == 'valid'){echo $is_valid; } else echo $is_invalid; ?></td>
                    </tr>
            ...
            <?php } elseif(isset($currentapp['realm'])) { ?>
                    <tr>
                        ...
                        <td><input <?php if($valid_discovery == 'invalid') echo 'style="border-color:red;"'?> class="mo_table_textbox" type="text" name="mo_oauth_provider_realm" value="<?php echo esc_attr($currentapp['realm']); ?>">&nbsp;&nbsp;&nbsp;<?php if($valid_discovery == 'valid'){echo esc_html($is_valid); } else echo esc_html($is_invalid); ?></td>
                    </tr>
                    <?php
                }
            }
			...
			<?php }?>
                ...
                <tr>
                    ...
                    <td><div style="padding:5px;"></div><input type="checkbox" class="mo_table_textbox" name="mo_oauth_authorization_header" <?php if(isset($currentapp['send_headers'])){if($currentapp['send_headers'] == 1){ echo 'checked';}}else {echo 'checked';}?> value="1"> <?php esc_html_e('Header','miniorange-login-with-eve-online-google-facebook'); ?><span style="padding:0px 0px 0px 8px;"></span><input type="checkbox" class="mo_table_textbox" name="mo_oauth_body"<?php if(isset($currentapp['send_body'])){if($currentapp['send_body'] == 1){ echo 'checked';}}else {echo 'checked';}?> value="1"> <?php esc_html_e('Body','miniorange-login-with-eve-online-google-facebook'); ?><div style="padding:5px;"></div></td>
                </tr>
                <tr>
			...
			<tr>
				...
				<td>
					...
					<!-- <?php if($is_other_app){?> -->
						<input id="mo_oauth_test_configuration" type="button" name="button" value="<?php esc_html_e('Test Configuration','miniorange-login-with-eve-online-google-facebook'); ?>" class="button button-primary button-large" onclick="testConfiguration()" />
					<!-- <?php } ?> -->
				</td>
			</tr>
			<tr>
