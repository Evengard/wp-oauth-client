<?php
 ...
 function mo_oauth_client_sign_in_settings_ui(){
	...
	<div id="wid-shortcode" class="mo_table_layout">
		<div style="padding:15px 0px 5px;"><h2 style="display: inline;"><?php _e('Sign in options','miniorange-login-with-eve-online-google-facebook'); ?></h2><span style="float: right;">[ <a href="https://developers.miniorange.com/docs/oauth/wordpress/client/login-options" target="_blank" rel="noopener"><?php _e('Click here','miniorange-login-with-eve-online-google-facebook'); ?></a><?php _e(' to know how this is useful','miniorange-login-with-eve-online-google-facebook')?>. ]</span></div>
	...
	<div id="advanced_settings_sso" class="mo_table_layout ">
		<div style="padding:15px 0px 10px;"><h3 style="display: inline;"><?php _e('Advanced Settings','miniorange-login-with-eve-online-google-facebook'); ?> </h3><span style="float: right;">[ <a href="https://developers.miniorange.com/docs/oauth/wordpress/client/forced-authentication" target="_blank" rel="noopener"><?php _e('Click here','miniorange-login-with-eve-online-google-facebook'); ?></a> <?php _e('to know how this is useful.','miniorange-login-with-eve-online-google-facebook'); ?> ]</span></div>
		<!--br><br-->
		...
		<p><input disabled type="checkbox"><b> <?php _e('Enable User login reports','miniorange-login-with-eve-online-google-facebook'); ?> </b> [<a href="https://developers.miniorange.com/docs/oauth/wordpress/client/user-analytics" target="_blank" rel="noopener"><?php _e('Learn more','miniorange-login-with-eve-online-google-facebook'); ?></a>]</p>
